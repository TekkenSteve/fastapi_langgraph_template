...
from agent_server.auth.middleware import LangGraphAuthBackend, LangGraphUser
...
"""
    ...
    @pytest.fixture
    def agent_server_config_with_auth(self, tmp_path, mock_auth_file, monkeypatch):
        """Create langgraph.json with auth.path pointing to mock auth"""
    ...
    def test_load_auth_from_config_path(self, agent_server_config_with_auth, mock_auth_file):
    ...
    @pytest.mark.asyncio
    async def test_auth_handler_from_config_works(self, agent_server_config_with_auth, mock_auth_file):
