...
import agent_server.app.main as agent_server_main
import agent_server.controller.http.middleware.logger_middleware as logger_middleware


def _reload_modules() -> None:
    """Reload settings, middleware, and app so they pick up env var changes."""
    importlib.reload(importlib.import_module("agent_server.config.settings"))
    importlib.reload(importlib.import_module("agent_server.controller.http.middleware.logger_middleware"))
    if "agent_server.app.main" in sys.modules:
        importlib.reload(sys.modules["agent_server.app.main"])
