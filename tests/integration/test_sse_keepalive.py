...
~60s were softly interrupted by the server. Root cause: the SSE response had
...
from agent_server.infra.sse import get_sse_headers, heartbeat_factory, sse_to_bytes
