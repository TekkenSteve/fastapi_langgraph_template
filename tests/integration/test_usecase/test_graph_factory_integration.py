...
""",
        ...
        service.config_path = graph_module_dir / "langgraph.json"
...
class TestGetGraphWithFactory:
    ...
    async def test_factory_called_per_request(self) -> None:
        ...
        with patch("agent_server.repo.database.db_manager") as mock_db:
...
""",
        ...
        mod = importlib.import_module("user_graphs.tracked")
        assert mod.call_log == [], (
...
""",
        ...
        mod = importlib.import_module("user_graphs.pi")
