...
from agent_server.auth.handlers import build_auth_context, handle_event
...
"""
    ...
    @pytest.fixture
    def agent_server_config_with_auth_handlers(self, tmp_path, mock_auth_file, monkeypatch):
        """Create langgraph.json with auth.path pointing to mock auth with handlers"""
    ...
    def test_load_auth_with_handlers(self, agent_server_config_with_auth_handlers, mock_auth_file):
        """Test that auth with handlers loads successfully"""
        from agent_server.auth.middleware import LangGraphAuthBackend
    ...
    @pytest.mark.asyncio
    async def test_thread_create_allowed_with_metadata_injection(
        self, agent_server_config_with_auth_handlers, mock_auth_file
    ):
    ...
    @pytest.mark.asyncio
    async def test_thread_search_returns_filters(self, agent_server_config_with_auth_handlers, mock_auth_file):
    ...
    @pytest.mark.asyncio
    async def test_assistant_delete_denied(self, agent_server_config_with_auth_handlers, mock_auth_file):
    ...
    @pytest.mark.asyncio
    async def test_assistant_create_allowed_with_metadata(self, agent_server_config_with_auth_handlers, mock_auth_file):
    ...
    @pytest.mark.asyncio
    async def test_unknown_resource_action_denied_by_default(
        self, agent_server_config_with_auth_handlers, mock_auth_file
    ):
    ...
    @pytest.mark.asyncio
    async def test_handler_precedence_specific_over_general(
        self, agent_server_config_with_auth_handlers, mock_auth_file
    ):
