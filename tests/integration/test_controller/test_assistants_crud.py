...
from agent_server.usecase.assistant_service import get_assistant_service
...
def client(mock_assistant_service):
    ...
    from agent_server.controller.http.routers import assistants as assistants_module
