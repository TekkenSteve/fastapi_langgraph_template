...
class TestCancelRun:
    ...
    def test_cancel_run_success(self):
        ...
        with (
            patch("agent_server.controller.http.routers.runs.streaming_service") as mock_streaming,
            patch(
...
class TestCancelRuns:
    """Test POST /runs/cancel (bulk cancel, i.e. the SDK's runs.cancel_many)."""
    ...
    def test_cancel_runs_no_matches_is_204(self) -> None:
        ...
        with patch("agent_server.controller.http.routers.runs.streaming_service") as mock_streaming:
            mock_streaming.interrupt_run = AsyncMock()
...
class TestJoinRun:
    ...
    def test_join_run_not_found(self):
        ...
        with patch(
            "agent_server.controller.http.routers.runs._get_session_maker", return_value=_make_session_maker(Session())
        ):
...
class TestWaitForRunTimeouts:
    ...
    def test_wait_for_run_timeout(self):
        ...
        with (
            ...
            patch("agent_server.usecase.execution.run_waiters.executor", mock_executor),
