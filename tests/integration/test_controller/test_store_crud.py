...
def client(mock_store):
    ...
    from agent_server.controller.http.routers import store as store_module
    ...
    import agent_server.repo.database as db_module
...
class TestGetStoreItem:
    ...
    def test_get_item_with_empty_namespace_query_param(self, client, mock_store):
        ...
        from agent_server.controller.http.routers.store import apply_namespace_scoping
        ...
        with patch(
            "agent_server.controller.http.routers.store.apply_namespace_scoping",
...
class TestSearchStoreItems:
    ...
    def test_search_items_with_auth_handler_filter_merge(self, client, mock_store):
        ...
        with patch(
            "agent_server.controller.http.routers.store.handle_event",
