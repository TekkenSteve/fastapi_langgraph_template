...
@pytest.fixture
def agent_server_config_with_custom_app(tmp_path, custom_app_file, monkeypatch):
    """Create langgraph.json with custom app configuration"""
...
@pytest.mark.asyncio
async def test_custom_routes_loaded(agent_server_config_with_custom_app, custom_app_file):
    ...
    from agent_server.config.graph_config import load_http_config
...
@pytest.mark.asyncio
async def test_custom_route_shadows_root(agent_server_config_with_custom_app, custom_app_file):
