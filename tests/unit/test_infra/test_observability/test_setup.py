...
class TestSetupObservability:
    ...
    def mock_deps(self):
        ...
        with (
            patch("agent_server.infra.observability.setup.get_observability_manager") as mock_get_manager,
            patch("agent_server.infra.observability.setup.otel_provider") as mock_otel_provider,
            patch("agent_server.infra.observability.setup.logger") as mock_logger,
        ):
