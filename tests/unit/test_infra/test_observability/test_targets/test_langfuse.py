...
class TestLangfuseTarget:
    ...
    def test_get_exporter_missing_credentials(self):
        ...
        with patch("agent_server.infra.observability.targets.langfuse.settings") as mock_settings:
    ...
    def test_ingestion_version_header_set(self):
        ...
        with (
            patch("agent_server.infra.observability.targets.langfuse.settings") as mock_settings,
            patch("agent_server.infra.observability.targets.langfuse.OTLPSpanExporter") as mock_exporter_cls,
        ):
