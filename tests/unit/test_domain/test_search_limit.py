"""Validation tests for threads/store search `limit` (shared MAX_SEARCH_LIMIT cap)."""
...
from agent_server.domain.store import StoreSearchRequest
from agent_server.domain.threads import ThreadSearchRequest
