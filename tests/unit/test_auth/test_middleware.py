...
from agent_server.auth.middleware import (
...
class TestLangGraphAuthBackend:
    ...
    def test_no_auth_warning_emitted_once_at_init(self, monkeypatch: pytest.MonkeyPatch):
        ...
        from agent_server.auth import middleware as auth_middleware
    ...
    def test_load_auth_instance_file_not_found(self):
        ...
        with (
            ...
            patch("agent_server.auth.middleware.load_auth_config", return_value=None),
        ):
            backend = LangGraphAuthBackend()
    ...
    def test_load_auth_instance_exception(self):
        ...
        with (
            patch(
                "agent_server.auth.middleware.load_auth_config",
    ...
    async def test_authenticate_noop_when_no_auth_instance(self):
        ...
        with patch("agent_server.auth.middleware.settings") as mock_settings:
    ...
    async def test_authenticate_http_exception(self):
        ...
        with patch("agent_server.auth.middleware.Auth") as mock_auth:
