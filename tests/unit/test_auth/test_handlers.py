...
from agent_server.auth.handlers import (
    AuthContextWrapper,
    build_auth_context,
    handle_event,
)
...
class TestHandleEvent:
    ...
    async def test_no_auth_instance_returns_none(self):
        ...
        with patch("agent_server.auth.handlers.get_auth_instance", return_value=None):
    ...
    async def test_no_handler_returns_none(self):
        ...
        with patch(
            "agent_server.auth.handlers.get_auth_instance",
    ...
    async def test_handler_raises_http_exception(self):
        ...
        with (
            ...
            patch("agent_server.auth.handlers.Auth") as mock_auth_class,
        ):
