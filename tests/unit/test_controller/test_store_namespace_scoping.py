...
from agent_server.controller.http.routers.store import _scope_attr_map, apply_namespace_scoping
...
class TestScopeAttrMap:
    """Verify the langgraph.json store.scopes loader, including the reserved-prefix guard."""
    ...
    def test_no_config_returns_empty(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        monkeypatch.setattr("agent_server.controller.http.routers.store.load_store_config", lambda: None)
    ...
    def test_config_without_scopes_returns_empty(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        monkeypatch.setattr("agent_server.controller.http.routers.store.load_store_config", lambda: {})
        assert _scope_attr_map() == {}
    ...
    def test_configured_scopes_are_returned(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        monkeypatch.setattr(
            "agent_server.controller.http.routers.store.load_store_config",
