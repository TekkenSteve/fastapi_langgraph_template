...
from agent_server.controller.http.routers.runs import wait_for_run
...
class TestWaitForRunAuthHandlers:
    ...
    async def test_wait_for_run_invokes_create_run_auth_handler(self) -> None:
        ...
        with (
            ...
            patch("agent_server.controller.http.routers.runs.heartbeat_wait_body", return_value=_single_event_stream()),
            patch(
