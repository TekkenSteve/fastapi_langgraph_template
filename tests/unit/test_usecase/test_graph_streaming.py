...
from agent_server.usecase.streaming.graph_streaming import (
...
class TestStreamGraphEvents:
    ...
    async def test_stream_events_context_filtering(self):
        ...
        with patch("agent_server.usecase.streaming.graph_streaming._filter_context_by_schema") as mock_filter:
