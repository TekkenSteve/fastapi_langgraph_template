...
class TestLocalExecutor:
    ...
    async def test_submit_creates_task(self) -> None:
        ...
        with (
            patch("agent_server.usecase.execution.run_executor.execute_run", mock_execute),
            patch("agent_server.usecase.execution.local_executor.make_run_trace_context", return_value=None),
        ):
            job = _make_job()
...
class TestRunExecutorBoundaryConditions:
    ...
    async def test_empty_context_passed_as_dict_not_none(self) -> None:
        ...
        with (
            ...
            from agent_server.usecase.execution.run_executor import execute_run
...
class TestExecutorFactory:
    def test_creates_local_when_redis_disabled(self) -> None:
        with patch("agent_server.usecase.execution.executor.settings") as mock_settings:
            mock_settings.redis.REDIS_BROKER_ENABLED = False
            from agent_server.usecase.execution.executor import _create_executor
