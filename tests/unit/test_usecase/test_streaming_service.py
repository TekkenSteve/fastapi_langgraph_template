...
from agent_server.domain import Run
from agent_server.usecase.streaming.streaming_service import StreamingService
...
class TestStreamingService:
    ...
    async def test_put_to_broker(self) -> None:
        ...
        with patch("agent_server.usecase.streaming.streaming_service.broker_manager") as mock_manager:
    ...
    async def test_interrupt_run_delegates_to_broker_manager(self) -> None:
        ...
        with patch("agent_server.usecase.streaming.streaming_service.broker_manager") as mock_bm:
    ...
    async def test_cleanup_run_drops_the_event_counter(self) -> None:
        ...
        with patch("agent_server.usecase.streaming.streaming_service.broker_manager"):
