...
from agent_server.controller.http.routers.threads import get_thread_state
...
class TestGetThreadState:
    ...
    async def test_graph_load_failure(self):
        ...
        with patch("agent_server.repo.graphs.langgraph_service.get_langgraph_service") as mock_service:
