...
from agent_server.config.graph_config import load_store_config
from agent_server.domain import (
    StoreDeleteRequest,
    StoreGetResponse,
    StoreItem,
...
from agent_server.domain.errors import BAD_REQUEST, NOT_FOUND
...
def _scope_attr_map() -> Mapping[str, list[str]]:
    """Map of namespace prefix -> list of User attributes, from langgraph.json store.scopes.
