...
from agent_server.config.graph_config import get_config_dir, load_auth_config
from agent_server.config.settings import settings
from agent_server.domain.errors import AgentProtocolError
...
class LangGraphAuthBackend(AuthenticationBackend):
    ...
    def _load_auth_instance(self) -> Auth | None:
        ...
        Resolution order:
        1. Load from langgraph.json auth.path config
